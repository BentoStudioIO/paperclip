...
description: "json-render @json-render/shadcn pre-built shadcn components (Card, Stack, Select, Input, etc.). Reference when consolidating Pharmia's hand-rolled catalog primitives."
slug: "json-render-shadcn"
metadata:
  paperclip:
    slug: "json-render-shadcn"
    skillKey: "company/57cd0843-fe5a-42d5-a6f6-c4e896fee84e/json-render-shadcn"
  paperclipSkillKey: "company/57cd0843-fe5a-42d5-a6f6-c4e896fee84e/json-render-shadcn"
  skillKey: "company/57cd0843-fe5a-42d5-a6f6-c4e896fee84e/json-render-shadcn"
key: "company/57cd0843-fe5a-42d5-a6f6-c4e896fee84e/json-render-shadcn"
---

> Imported from [vercel-labs/json-render](https://github.com/vercel-labs/json-render) `skills/shadcn/SKILL.md` (matches our `@json-render/shadcn@0.14.1` install). Re-sync via `gh api repos/vercel-labs/json-render/contents/skills/shadcn/SKILL.md -H "Accept: application/vnd.github.raw"` when upgrading.
