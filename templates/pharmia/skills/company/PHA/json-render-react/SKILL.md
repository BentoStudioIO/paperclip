...
description: "json-render @json-render/react API: Renderer, JSONUIProvider, useJsonRenderMessage, useStateStore, useBoundProp, defineRegistry. Use when wiring frontend renderers, message-parts consumption, or component registries."
slug: "json-render-react"
metadata:
  paperclip:
    slug: "json-render-react"
    skillKey: "company/57cd0843-fe5a-42d5-a6f6-c4e896fee84e/json-render-react"
  paperclipSkillKey: "company/57cd0843-fe5a-42d5-a6f6-c4e896fee84e/json-render-react"
  skillKey: "company/57cd0843-fe5a-42d5-a6f6-c4e896fee84e/json-render-react"
key: "company/57cd0843-fe5a-42d5-a6f6-c4e896fee84e/json-render-react"
---

> Imported from [vercel-labs/json-render](https://github.com/vercel-labs/json-render) `skills/react/SKILL.md` (matches our `@json-render/react@0.14.1` install). Re-sync via `gh api repos/vercel-labs/json-render/contents/skills/react/SKILL.md -H "Accept: application/vnd.github.raw"` when upgrading.
