...
description: "json-render @json-render/core API: schemas, catalogs, SpecStream compilers, validateSpec/autoFixSpec, diffToPatches, createStateStore. Use when working with the backend catalog or fence-extraction pipeline."
slug: "json-render-core"
metadata:
  paperclip:
    slug: "json-render-core"
    skillKey: "company/57cd0843-fe5a-42d5-a6f6-c4e896fee84e/json-render-core"
  paperclipSkillKey: "company/57cd0843-fe5a-42d5-a6f6-c4e896fee84e/json-render-core"
  skillKey: "company/57cd0843-fe5a-42d5-a6f6-c4e896fee84e/json-render-core"
key: "company/57cd0843-fe5a-42d5-a6f6-c4e896fee84e/json-render-core"
---

> Imported from [vercel-labs/json-render](https://github.com/vercel-labs/json-render) `skills/core/SKILL.md` (matches our `@json-render/core@0.14.1` install). Re-sync via `gh api repos/vercel-labs/json-render/contents/skills/core/SKILL.md -H "Accept: application/vnd.github.raw"` when upgrading.
